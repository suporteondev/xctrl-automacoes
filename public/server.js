...
server.use('/api/', require(`./routes/secure/gerenciador/transferirperfis`))
server.use('/api/', require(`./routes/secure/controlevps/adicionar`))
server.use('/api/', require(`./routes/secure/controlevps/apagar`))
server.use('/api/', require(`./routes/secure/controlevps/listar`))
